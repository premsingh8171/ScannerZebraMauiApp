...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ScannerControlMAUISampleApp.dll" comes first in this list. */
		"ScannerControlMAUISampleApp.dll",
		"Microsoft.Maui.dll",
		...
		"ScannerSDKiOSBinding.dll",
		"ZebraAndroidScannerLibrary.dll",
		"ZebraBarcodeScannerSDK.dll",
	};
